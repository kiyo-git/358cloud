@extends('admin.app')
@section('title', '元会員基盤ユーザー画面 - 一覧')
@section('content')
    <p class="content-title">元会員基盤ユーザー一覧画面</p>
            ...
            @if(!$original_users->isEmpty())
                @foreach ($original_users as $user)
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td><a href="{{ route('admin.original-user.show', $user->id) }}">View</a></td>
                    </tr>
                @endforeach
            @endif
        </tbody>
    ...
    <div style="margin-top: 3%;">
        {{ $original_users->links('vendor.pagination.admin.tailwind') }}
    </div>
@endsection
