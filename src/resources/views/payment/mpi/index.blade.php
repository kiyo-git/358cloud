...
@endphp
@extends('payment.app')
@section('title', 'PIST6 クレジットカード決済（3D認証）')
@section('content')
    <div class="row">
                ...
                <div class="ti-body__option">
                  <div class="ti-option">
                    <div class="ti-option__inner">
                              ...
                              <li class="c-select-list__item _border">
                                <div class="ti-select">
                                  <div class="ti-select__seat">
                                    ...
                                    <p class="ti-select__seat-position">E レギュラーシート 9列 74番</p>
                                  </div>
                                  <div class="ti-select__seat">
                                    <div class="ti-select__seat-icon" aria-hidden="true">
                                      <svg class="icon icon-seat" viewBox="0 0 12 12" aria-hidden="true">
                                    ...
                                    <p class="ti-select__seat-position">E 車いすシート 1番</p>
                                  </div>
                                  <div class="ti-select__seat">
                                    <div class="ti-select__seat-icon" aria-hidden="true">
                                      <svg class="icon icon-seat" viewBox="0 0 12 12" aria-hidden="true">
                                    ...
                                    <p class="ti-select__seat-position">F BOXシート 1番</p>
                                  </div>
                                  <div class="ti-select__seat">
                                    <div class="ti-select__seat-icon" aria-hidden="true">
                                      <svg class="icon icon-seat" viewBox="0 0 12 12" aria-hidden="true">
                                    ...
                                    <p class="ti-select__seat-position">VIPルーム 1903</p>
                                  </div>
                                  <div class="ti-select__price total_price">
                                    <h3 class="w-100 fs20 fw600">お支払い金額</h3>
                                    <p class="ti-select__price-detail w-100"><span class="db ti-select__price-head w-50 al">小計：</span><span class="db ti-select__price-value w-50 ar">¥{{number_format($amount)}}<br class="viewsp">（税込）</span></p>
                      ...
                      <form method="post" action="{{ route('payment.mpi.authorize') }}" class="needs-validation"  onsubmit="return document.getElementById('canSubmit').value == 'true';"
                        ...
                        <input type="hidden" id="paymentMode" name="paymentMode" value="mpi-complete">
                        <input type="hidden" id="token" name="token" value="">
                        <input type="hidden" id="canSubmit" value="false">
                        <div class="ti-option__select">
                          <div class="c-select-frame">
                            <div class="c-select-frame__head">
                              <p class="c-select-frame__ttl">クレジット決済</p>
                            </div>
                            <div class="c-select-frame__body _no-border">
                              <ul class="c-select-list">
                                <li class="c-select-list__item _border">
                                  <div class="ti-select">
                                    ...
                                    @foreach ($cards as $card)
                                      <div class="ti-select__seat credit" id="cardSection{{ $card->getCardId() }}">
                                        <div class="rg-regist__inputs half">
                                          <div class="rg-regist__inputs-items">
                                            <div class="rg-regist__inputs-item">
                                              <label class="rg-regist__input-label" for="paychoice{{ $card->getCardId() }}">
                                                <div class="c-input-check">
                                                  <input id="paychoice{{ $card->getCardId() }}" class="c-input-check__body" type="radio" name="cardId" value="{{ $card->getCardId() }}"><span class="c-input-check__marker" aria-hidden="true"></span>
                                                </div>
                                                <span class="rg-regist-term__input-txt">
                                                  ****-****-****-{{ substr($card->getCardNumber(), 12, 4) }}
                                                </span>
                                                <span class="rg-regist-term__input-img w-icn" style="border:0;"></span>
                                                <!--	img(src="./dst/img/page/credit02.png")-->
                                                <span class="rg-regist-term__input-edit"><button id="cardRemove{{ $card->getCardId() }}" name="cardRemove" onsubmit="return false;" onclick="requestRemoveCard('{{ route('payment.mpi.remove-card') }}', '{{ csrf_token() }}', '{{ $card->getCardId() }}', '{{ $card->getCardNumber() }}', '{{ config('payment.message.confirm.mpi.card_remove') }}');">削除</button></span>
                                              </label>
                                            </div>
                                          </div>
                                        </div>
                                    ...
                                    @endforeach
                                    <!-- 新しいカード -->
                                    <div class="ti-select__seat last">
                                      <div class="rg-regist__inputs half">
                                        <div class="rg-regist__inputs-items">
                                          <div class="rg-regist__inputs-item">
                                            <label class="rg-regist__input-label" for="paychoiceNewCard">
                                              <div class="c-input-check">
                                                <input id="paychoiceNewCard" class="c-input-check__body" type="radio" name="cardId" value="newCard" checked><span class="c-input-check__marker" aria-hidden="true"></span>
                                              </div>
                                              <span class="rg-regist-term__input-txt">新しいクレジットカードを登録する</span>
                                            </label>
                                          </div>
                                        </div>
                                      </div>
                                    </div>
                                    <div class="ti-pay_credit" style="padding: 1.7rem 3.2rem; border-top: none !important;">
                                      <p class="ti-regist__label">カード番号<span class="ti-regist__label-required">必須</span></p>
                                      <div class="ti-regist__inputs">
                                        <div class="ti-regist__inputs-item">
                                          <input
                                            class="c-input-text" type="text" inputmode="numeric"
                                            id="card_number" placeholder="0123456789012345" pattern="[0-9]{14,16}"
                                            maxlength="19" required>
                                        </div>
                                      </div>
                                    </div>
                                    <div class="ti-pay_credit" style="padding: 1.7rem 3.2rem; border-top: none !important;">
                                      <p class="ti-regist__label">名義人名<span class="ti-regist__label-required">必須</span></p>
                                      <div class="ti-regist__inputs">
                                        <div class="ti-regist__inputs-item">
                                          <input class="c-input-text" type="text" id="cardholderName" name="cardholderName"
                                    ...
                                    <div class="ti-pay_credit" style="padding: 1.7rem 3.2rem; border-top: none !important;">
                                      <p class="ti-regist__label">有効期限<span class="ti-regist__label-required">必須</span></p>
                                      <div class="ti-regist__inputs w30">
                                        <div class="ti-regist__inputs-item">
                                          <div class="c-input-select">
                                            <select class="c-input-select__body" id="cc_exp_mm">
                                        ...
                                        <div class="ti-regist__inputs-item">
                                          <div class="c-input-select">
                                            <select class="c-input-select__body" id="cc_exp_yy">
                                              <option value="" selected="selected" disabled="disabled">YY</option>
                                    ...
                                    <div class="ti-pay_credit" style="padding: 1.7rem 3.2rem; border-top: none !important;">
                                      <p class="ti-regist__label">セキュリティコード<span class="ti-regist__label-required">必須</span></p>
                                      <div class="ti-regist__inputs">
                                        <div class="ti-regist__inputs-item w50">
                                          <input class="c-input-text" type="text" inputmode="numeric" id="cc_csc"
                                                pattern="[0-9]{3,4}"
                                    ...
                                    <div class="ti-pay_credit" style="padding: 1.7rem 3.2rem; border-top: none !important;">
                                      <p id="authorization_comment" class="authorization_comment">　</p>
                                    </div>
                                  </div>
                                </li>
                              </ul>
                        ...
                        <div class="ti-option__confirm mt50">
                          <button class="c-btn-rect" id="proceed_payment" type="submit"><span class="c-btn-rect__txt">お支払いを行う</span></button>
                        </div>
                      </form>
                      <div class="ti-option__confirm mt50">
                      ...
                      <div class="ti-body__back">
                        <div class="ti-back"><a class="ti-back__link" href="{{ route('payment.index') }}"><span class="ti-back__link-arrow" aria-hidden="true"></span><span class="ti-back__link-txt">決済方法を変更</span></a></div>
                      </div>
                    </div>
                  </div>
                </div>
