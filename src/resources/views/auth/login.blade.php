@extends('auth.app')
@section('title', 'ログイン | PIST6オフィシャルサイト')
@section('content')
    <div class="l-content">
                  ...
                  <section class="rg-regist _regist">
                    <div class="rg-regist__inner">
                      <header class="rg-regist__header">
                        <h2 class="rg-regist__header-txt al">ログイン</h2>
                      </header>
                      <form action={{ route('login.confirm') }} method='post' class="rg-regist__body">
                        @csrf
                          ...
                          <div class="rg-regist__info-item">
                            ...
                            <div class="rg-regist__inputs">
                              <div class="rg-regist__inputs-item">
                                <input class="c-input-text" type="email" name="email" value="">
                              </div>
                            </div>
                          </div>
                          <div class="rg-regist__info-item">
                            ...
                            <div class="rg-regist__inputs">
                              <div class="rg-regist__inputs-item">
                                <input class="c-input-text" type="password" name="password" value="" required>
                              </div>
                            </div>
                          </div>
                          <div class="rg-regist__info-item">
                        ...
                        <div class="rg-regist__submit">
                          <div class="rg-regist__submit-inner ac">
                            <button class="c-btn-rect brid30" type="submit"><span class="c-btn-rect__txt">ログイン</span></button>
                            <a class="rg-regist-term__link-txt dib fs16 mt20" href="{{ route('user.pwd.reset') }}">▶︎パスワードを忘れた場合</a>
                          </div>
                        </div>
                        <div class="rg-regist__info announce">
                          <div class="announce__container bg-f2">
                            <h3 class="ac fs16 mb30">■ログイン方式の変更に関して </h3>
                            <p class="fs16"> 株式会社MIXIから提供いただいておりましたMIXI Mサービスですが、2022年6月以降、当サイトでの利用を中止させていただくこととなりました。<br>MIXI M利用中止に伴い、新たにメールアドレスとパスワードでログインいただく形で、当サイトをご利用いただくこととなります。<br>SMSログインを行っていたユーザー様は、お手数ですが以下のページより、データの移行を行っていただき、メールアドレスとパスワードを設定の上、ログインいただけると幸いです。</p>
                          </div>
                        </div>
                    </form>
                      <div class="rg-regist__body nobg ac fs16"><a class="dib" href="{{route('user.email.input')}}">▶新規会員登録はこちら</a></div>
                    </div>
                  </section>
                </div>
              </div>
