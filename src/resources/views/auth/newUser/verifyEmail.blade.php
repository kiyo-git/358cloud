                  ...
                  <section class="rg-regist _regist">
                    <div class="rg-regist__inner">
                      <header class="rg-regist__header">
                        <h2 class="rg-regist__header-txt al">新規会員登録</h2>
                      </header>
                      <form action="{{ route('user.email.sent') }}" method="POST" class="rg-regist__body">
                        @csrf
                          ...
                          <div class="rg-regist__info-item">
                            ...
                            <div class="rg-regist__inputs">
                              <div class="rg-regist__inputs-item">
                                <input class="c-input-text" type="email" name="email" value="{{old('email')}}">
                              </div>
                            </div>
                          </div>
                          <div class="rg-regist__info-item">
                              ...
                              <div class="rg-regist__inputs-items">
                                <div class="rg-regist__inputs-item">
                                    <label class="rg-regist__input-label">
                                        ...
                                        <p class="rg-regist-term__ttl ml15 fs16">PIST6の<a class="rg-regist-term__link"
                        ...
                        <div class="rg-regist__submit">
                          <div class="rg-regist__submit-inner">
                            <button class="c-btn-rect brid30" type="submit"><span class="c-btn-rect__txt">送信</span></button>
                          </div>
                        </div>
                    </form>
