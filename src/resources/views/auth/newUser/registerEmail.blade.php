@extends('auth.app')
@section('title', '登録完了 | PIST6オフィシャルサイト')
@section('content')
    <div class="l-content">
            ...
            <header class="l-regist__header">
              <div class="rg-header">
                <div class="rg-header__inner">
                  <h2 class="rg-header__ttl"><span class="rg-header__ttl-purpose">メール送信完了</span></h2>
                  <p class="fs16 rg-header__lead">ご登録ありがとうございます。<br>先ほど、登録認証メールをお送りしました。<br></p><strong class="fs12 db mt25"><br>account@info.pist6.com<br><br>を受信許可していただき再度ご登録ください。</strong>
                </div>
              </div>
            </header>
          </div>
