            ...
            <header class="l-regist__header">
              <div class="rg-header">
                <div class="rg-header__inner">
                  <h2 class="rg-header__ttl"><span class="rg-header__ttl-purpose">パスワード登録完了</span></h2>
                  <p class="rg-header__lead">ご登録ありがとうございます。<br>パスワードが再設定されました。<br>ログイン画面から、ログインを行なってください。</p>
                </div>
              </div>
            </header>
              <div class="rg-regist__submit">
                <div class="rg-regist__submit-inner">
                  <button class="c-btn-rect brid30" type="button" onclick="location.href='{{ route('login') }}' "><span class="c-btn-rect__txt">ログイン画面へ</span></button>
                </div>
              </div>
          </div>
        </section>
