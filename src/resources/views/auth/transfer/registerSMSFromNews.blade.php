@extends('auth.app-from-news')
@section('title', 'PIST6 データの移行')
@section('content')
    <div class="l-content">
                                ...
                                <section class="rg-regist _regist">
                                    <div class="rg-regist__inner">
                                        <header class="rg-regist__header">
                                            <h2 class="rg-regist__header-txt al">ログイン方式の変更に関して</h2>
                                        </header>
                                        <form action="{{ route('transfer.sms.cert') }}" method="post" class="rg-regist__body">
                                            <div class="rg-regist__info announce">
                                                <div class="announce__container bg-f2">
                                                    <h3 class="ac fs16 mb30">■ログイン方式の変更に関して </h3>
                                                    <p class="fs16">株式会社MIXIから提供いただいておりました会員・決済サービスのMIXI Mは、2022年6月以降、当サイトでの利用を中止させていただくこととなりました。<br>
                                                        MIXI M利用中止により、電話番号でのSMS認証によるログインから新たにメールアドレスとパスワードでログインいただく形で、当サイトをご利用いただくこととなります。<br><br>
                                                        また、ログイン方式の変更と、管理会社の変更に伴い、利用規約を変更させていただいております。<br>
                                                        <a class="rg-regist-term__link-txt" href="https://www.pist6.com/guide/service-guide/terms/">▶利用規約はこちら</a><br><br>
                                                        これまで電話番号によるSMS認証にてログインしていたお客様は、以下のページより、データ移行手続きを行っていただくことで、これまでの購入データやご登録情報を引き続きご利用いただくことができます。<br>
                                                        お手数をお掛けしまして大変申し訳ございませんが、データ移行のお手続きをお願いいたします。<br>
                                                        引き続きPIST6へご愛顧いただけると幸いです。<br>
                                                    </p>
                                                    <div class="data_transfer_link mt30 al fs16"><a class="db mt05" href="{{ route('login') }}" target="_self">▶既にデータ移行済の方はこちら</a></div>
                                                </div>
                                            </div>
                                            <div class="rg-regist__info announce">
                                                <div class="announce__container">
                                                    <p class="fs16">■データ移行手順<br>1.これまでログインしていた電話番号でSMS認証を行う。<br>2.電話番号宛てに送信されたSMSに記載されている認証コードを入力する。<br>3.基本情報の確認及び、ログイン用のメールアドレスとパスワードを設定する。<br>4.設定完了すると、データ移行は完了となります。<br>※以降は、ログインページより、メールアドレスとパスワードでのログインとなります。</p>
                                                </div>
                                            </div>
                                            @csrf
                                            <div class="rg-regist__info mt50">
                                                @if ($errors->any())
                                                ...
                                                <div class="rg-regist__info-item">
                                                    <p class="rg-regist__label">電話番号<span
                                                            class="rg-regist__label-required">必須</span></p>
                                                    <div class="rg-regist__inputs">
                                                        <div class="rg-regist__inputs-item">
                                                            <input class="c-input-text" type="number" name="phone_number"
                                                                value="">
                                                        </div>
                                                    </div>
                                                </div>
                                                            ...
                                                            <div class="rg-regist__inputs-item">
                                                                <label class="rg-regist__input-label">
                                                                    <div class="c-input-check">
                                                                        <input class="c-input-check__body" type="checkbox"
                                                                            name="agree_term" ><span
                                                                            class="c-input-check__marker"
                                                                            aria-hidden="true"></span>
                                                                    </div>
                                                                    <p class="rg-regist-term__ttl ml15 fs16">PIST6の<a
                                                                            class="rg-regist-term__link"
                                                                            href="https://pist6.com/guide/service-guide/terms/"
                                                                            target="_blank"></a><span
                                                                            class="rg-regist-term__link-txt">新規約に</span>同意する。
                                                                    </p>
                                                                </label>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="rg-regist__submit">
                                                <div class="rg-regist__submit-inner">
                                                    <button class="c-btn-rect brid30" type="submit"><span
                                                            class="c-btn-rect__txt">送信</span></button>
                                                </div>
                                            </div>
                                        </form>
                                        <div class="rg-regist__body nobg ac fs16"><a class="dib" href="{{route('login')}}" target="_self">▶ログインはこちらから</a></div>
                                        <div class="rg-regist__body nobg ac fs16"><a class="dib" href="{{route('user.email.input')}}" target="_self">▶会員登録はこちら</a></div>
                                    </div>
                                </section>
                            </div>
                        </div>
    ...
    <div class="l-pagetop" id="pagetop">
        <div class="l-pagetop__inner"><a class="c-pagetop js-pagetop" href="#top"><span class="c-pagetop__arrow"
                    aria-hidden="true">
                    <svg class="c-pagetop__arrow-entity" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 14 28">
                        <path fill-rule="evenodd"
                            d="M9.000,12.632 L9.000,28.000 L5.000,28.000 L5.000,12.632 L0.294,12.632 L7.081,0.876 L13.868,12.632 L9.000,12.632 Z">
                        </path>
