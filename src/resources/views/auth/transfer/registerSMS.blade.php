                                ...
                                <section class="rg-regist _regist">
                                    <div class="rg-regist__inner">
                                        <header class="rg-regist__header">
                                            <h2 class="rg-regist__header-txt al">データの移行</h2>
                                        </header>
                                        <form action="{{ route('transfer.sms.cert') }}" method="post" class="rg-regist__body">
                                                            ...
                                                            <div class="rg-regist__inputs-item">
                                                                <label class="rg-regist__input-label">
                                                                    ...
                                                                    <p class="rg-regist-term__ttl ml15 fs16">PIST6の<a
                                                                            ...
                                                                            target="_blank"><span
                                                                            class="rg-regist-term__link-txt">新規約に</span>同意する。</a>
                                                                    </p>
                                                                </label>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="rg-regist__info announce">
                                                <div class="announce__container bg-f2">
                                                    ...
                                                    <p class="fs16"> 株式会社MIXIから提供いただいておりましたMIXI
                                                        <br>Mサービスですが、2022年6月以降、当サイトでの利用を中止させていただくこととなりました。<br>MIXI
                                                        M利用中止に伴い、新たにメールアドレスとパスワードでログインいただく形で、当サイトをご利用いただくこととなります。<br>お客様にはご不便をおかけしまして、大変申し訳ございません。<br><br>・データ移行手順<br>1.これまでログインしていた電話番号でSMS認証を行う。<br>2.電話番号宛てに送信されたSMSに記載されている認証コードを入力する。<br>3.基本情報の確認及び、ログイン用のメールアドレスとパスワードを設定する。<br>4.設定完了すると、データ移行は完了となります。<br>※以降は、ログインページより、メールアドレスとパスワードでのログインとなります
                                                    </p>
                                                    <div class="data_transfer_link mt30 ac fs16"><a class="db" href="{{ route('login') }}" target="_self">▶既ににデータ移行済の方はこちら（ログイン）</a></div>
                                                </div>
                                            </div>
                                        </form>
                                        <div class="rg-regist__body nobg ac fs16"><a class="dib"
                                                href="{{route('user.email.input')}}" target="_self">▶新規会員登録はこちら</a></div>
                                    </div>
                                </section>
                            </div>
                        </div>
