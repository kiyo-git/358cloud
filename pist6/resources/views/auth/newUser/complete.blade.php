@extends('auth.app')
@section('title', '会員登録完了| PIST6オフィシャルサイト')
@section('content')
    <div class="l-content">
        ...
        <div class="rg-flow">
          <div class="rg-flow__inner">
            <ul class="rg-flow__list">
              ...
              <li class="rg-flow__item">
                <p class="rg-flow__step"><span class="rg-flow__step-num">STEP2:<span class="rg-flow__step-status">確認</span</span></span></p>
              </li>
            ...
            <header class="l-regist__header">
              <div class="rg-header">
                <div class="rg-header__inner">
                  <h2 class="rg-header__ttl"><span class="rg-header__ttl-purpose">基本情報登録完了</span></h2>
                  <p class="rg-header__lead">ご登録ありがとうございます。</p>
                </div>
              </div>
            </header>
                      ...
                      <div class="rg-regist__body nobg">
                        <div class="rg-regist__submit">
                          <div class="rg-regist__submit-inner">
                            <button class="c-btn-rect brid30" type="button"><span class="c-btn-rect__txt">マイページへ</span></button>
                          </div>
                        </div>
                      </div>
                    </div>
            ...
            <div class="l-regist__body nontitle">
              <div class="rg-body">
                <div class="rg-body__regist">
                  <section class="rg-regist _regist">
                    <div class="rg-regist__inner">
                      <div class="rg-regist__body nobg"><a class="noud" href="" target="_blank"><img src="./dst/img/page/dummy01.jpg"></a></div>
                    </div>
                  </section>
                </div>
              </div>
