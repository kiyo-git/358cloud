            ...
            <header class="l-regist__header">
              <div class="rg-header">
                <div class="rg-header__inner">
                  <h2 class="rg-header__ttl"><span class="rg-header__ttl-purpose">新規会員登録<span class="rg-header__ttl-action">お客様情報の入力</span></span></h2>
                ...
                <div class="rg-body__regist">
                  <section class="rg-regist _regist">
                    <div class="rg-regist__inner">
                      ...
                      <form  action="{{ route('user.complete') }}" method="Post" class="rg-regist__body">
                        @csrf
                        <div class="rg-regist__confirm">
                          ...
                          <div class="rg-regist__confirm-item">
                            <dl class="rg-regist__define">
                              ...
                              <dd class="rg-regist__define-body">{{ (($insert_items->mailmagazine) == 0)? '受け取らない' : '受け取る' }}</dd>
                            </dl>
                          </div>
                        </div>
                        ...
                        <div class="rg-regist__submit kmt00">
                          <div class="rg-regist__submit-inner">
                            <button class="c-btn-rect gray" type="button" onclick="history.back()"><span class="c-btn-rect__txt">戻る</span></button>
                          </div>
                        </div>
                    </form>
                    </div>
