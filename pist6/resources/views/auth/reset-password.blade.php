                ...
                <section class="rg-regist _regist">
                  <div class="rg-regist__inner">
                    <header class="rg-regist__header">
                      <h2 class="rg-regist__header-txt al">パスワード設定</h2>
                      <p class="mt30 fs14">新しいパスワードを作成してください。</p>
                      <p class="mt30 fs14 validation"><span class="icn-check"></span><span class="fs20 fw600">半角英数組み合わせ</span><br><span class="icn-check"></span><span class="fs20 fw600">8文字以上</span><br><span class="icn-check"></span><span class="fs20 fw600">15文字以内</span></p>
                    </header>
                    <div class="rg-regist__body">
                      <form method="POST" action="{{ route('password.store') }}">
                        ...
                        <div class="rg-regist__info">
                            ...
                            <p class="rg-regist__label">新規パスワード<span class="rg-regist__label-required">必須</span></p>
                            <div class="rg-regist__inputs">
                                <div class="rg-regist__inputs-item">
                                <input class="c-input-text" type="password" name="password" value="">
                                </div>
                            </div>
                            </div>
                            <div class="rg-regist__info-item">
                            <p class="rg-regist__label">パスワード確認<span class="rg-regist__label-required">必須</span></p>
                            <div class="rg-regist__inputs">
                                <div class="rg-regist__inputs-item">
                                <input class="c-input-text" type="password" name="password_confirmation" value="">
                                </div>
                            </div>
                            </div>
                        </div>
                        <div class="rg-regist__submit">
                          <div class="rg-regist__submit-inner">
                            <button class="c-btn-rect brid30" type="submit"><span class="c-btn-rect__txt">パスワードのリセット</span></button>
                          </div>
                        </div>
                      </form>
                    </div>
