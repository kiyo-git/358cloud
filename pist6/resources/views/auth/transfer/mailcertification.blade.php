            ...
            <header class="l-regist__header">
              <div class="rg-header">
                <div class="rg-header__inner">
                  <h2 class="rg-header__ttl"><span class="rg-header__ttl-purpose">認証メール送信完了</span></h2>
                  <p class="rg-header__lead">ご登録ありがとうございます。<br>先ほど、ご変更いただいたメールアドレス宛に認証URLを送信しました。<br>メール内に記載している認証URLをクリックし、登録を進めてください。</p>
                </div>
              </div>
            </header>
          </div>
